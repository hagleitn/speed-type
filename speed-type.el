...
(setq speed-type--min-chars 10)
(setq speed-type--max-chars 10)
(setq speed-type--skip-paragraphs 1)
(setq speed-type--max-paragraphs-for-code-samples 500)
